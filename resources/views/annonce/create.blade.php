            ...
            <div class="col-lg-9">
                <div class="card border-0 shadow mb-4 ">
                    <div class="card-body card-form p-4">
                        <h3 class="fs-4 mb-1">Détails du poste</h3>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="mb-4 col-md-6">
                                ...
                                <input type="text" class="form-control" name="departement" value="{{old('departement')}}">
                                @error('departement')
                                  <div class="text-danger">
                                    {{$message}}
                                  </div>
                        ...
                        <div class="row">
                            <div class="mb-4 col-md-6">
                                <label for="" class="mb-2">Nom de l'entreprise</label>
                                <input type="text" placeholder="Entreprise" id="company_name" name="entreprise" class="form-control">
                            </div>

                            <div class="mb-4 col-md-6">
                                <label for="" class="mb-2">ville</label>
                                <input type="text" placeholder="Location" id="location" name="ville" class="form-control">
                                @error('ville')
                                <div class="text-danger">
                                {{$message}}
                              </div>
