...
<x-Adminmaster>
    ...
    <a href="{{ route('registration.create', ['view' => 'recruteur']) }}" role="button" class="button-3">+ Ajouter recruteur</a>
</div>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $recruteur->id }}</td>
                    <td><img src="{{ asset('storage/'.$recruteur->logo) }}" alt="recruteur Image" class="profile-image"></td>
                    <td>{{ $recruteur->nom }}</td>
                    ...
                    <td>
                        <div class="action-dots float-end">
                            <div class="d-flex justify-content-center mx-3"> <!-- Center the buttons and add margin on the y-axis -->
                                <a class="btn btn-warning me-2" href="{{ route('rec.edit',$recruteur->id) }}"> <!-- Add margin to the right of the button -->
                                    <svg class="feather feather-edit" fill="none"  height="15px" width="15px" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                                </a> 
                                <form method="POST" action="{{ route('rec.destroy', $recruteur->id) }}">
                                    @csrf
                                    @method('DELETE')  
                    ...
                    <td><a class="btn btn-primary" href="{{route('rec.show',$recruteur->id)}}">voir plus</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
